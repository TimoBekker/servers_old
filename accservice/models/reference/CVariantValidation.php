...
/**
 * This is the model class for table "c_variant_validation".
 *
 * @property string $id
 ...
 */
class CVariantValidation extends \yii\db\ActiveRecord
{
    public static $tableLabelName = "Виды аттестаций";
    /**
     * @inheritdoc
     */
    public static function tableName()
    {
        return 'c_variant_validation';
    }
    ...
    {
        return $this->hasMany(RInformationSystem::className(), ['validation' => 'id']);
    }
