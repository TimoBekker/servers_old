...
/**
 * This is the model class for table "c_method_license".
 *
 * @property string $id
 ...
 */
class CMethodLicense extends \yii\db\ActiveRecord
{
    public static $tableLabelName = "Способы лицензирования";
    /**
     * @inheritdoc
     */
    public static function tableName()
    {
        return 'c_method_license';
    }
    ...
    {
        return $this->hasMany(RSoftware::className(), ['method_license' => 'id']);
    }
