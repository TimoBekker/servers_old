...
/**
 * This is the model class for table "c_type_software".
 *
 * @property string $id
 ...
 */
class CTypeSoftware extends \yii\db\ActiveRecord
{
    public static $tableLabelName = "Типы ПО";
    /**
     * @inheritdoc
     */
    public static function tableName()
    {
        return 'c_type_software';
    }
    ...
    {
        return $this->hasMany(RSoftware::className(), ['type' => 'id']);
    }
