    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?= $modalName = 'Вы действительно хотите удалить нормативно-правовой акт?' ?></h4>
            </div>
            <div class="modal-body">
                Данное действие удалит всю информацию о нормативно-правовом акте (НПА),<br/>
                включая все связи НПА с другими сущностями: оборудованием,<br/>
                информационными системами, контрактами, ответственными лицами.
            </div>
