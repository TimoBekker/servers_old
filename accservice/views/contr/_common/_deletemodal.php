    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?= $modalName = 'Вы действительно хотите удалить контракт?' ?></h4>
            </div>
            <div class="modal-body">
                Данное действие удалит всю информацию о контракте,<br/>
                включая все связи контракта с другими сущностями:<br/>
                дистрибутивами ПО, ответственными лицами,<br/>
                информационными системами, нормативно-правовыми актами.
            </div>
