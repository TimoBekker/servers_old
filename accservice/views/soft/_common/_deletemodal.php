    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?= $modalName = 'Вы действительно хотите удалить дистрибутив ПО?' ?></h4>
            </div>
            <div class="modal-body">
                Данное действие удалит всю информацию о дистрибутиве,<br/>
                включая все связи дистрибутива с другими сущностями:<br/>
                с другими дистрибутивами, установленным ПО, информационными<br/>
                системами, контрактами, документацию, права доступа<br/>
                пользователей к дистрибутивам.
            </div>
